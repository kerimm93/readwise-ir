...
Ein versehentliches Leerzeichen nach einem Prädikat-Doppelpunkt wird kanonisiert, etwa `category: epub` zu `category:epub`. Leerzeichen innerhalb zitierter Werte bleiben unverändert, beispielsweise in `title:"foo category: bar"`.
